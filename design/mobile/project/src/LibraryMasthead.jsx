...
function LibraryMasthead({
  ...
  return (
    <div style={{
      ...
      <div className="lib-masthead-actions" style={{ display: 'flex', alignItems: 'center', gap: 10, flexShrink: 0 }}>
