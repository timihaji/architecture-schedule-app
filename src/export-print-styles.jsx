...
(function () {
  ...
  var css = [
    ...
    '  html, body { background: white !important; color: var(--ink, #1a1815) !important; margin: 0 !important; padding: 0 !important; }',
    /* Avoid any inherited horizontal scrollbars / fixed widths from the   */
    /* app shell leaking into the printed page.                            */
    '  #export-print-region { width: auto !important; max-width: 100% !important; margin: 0 !important; padding: 0 !important; }',
    ...
    /* Content-toggle visibility is the renderer's responsibility now —     */
    /* each profile reads the `content` object and omits DOM nodes        */
    /* directly. (Phase 1 hid via CSS attribute rules, but that hardcoded */
    /* the toggle set; profile-driven toggles are open-ended.)            */
  ...
  function applyExportPrintConfig(cfg) {
    ...
    // (Content toggles are NOT written to the DOM; renderers read them.)
